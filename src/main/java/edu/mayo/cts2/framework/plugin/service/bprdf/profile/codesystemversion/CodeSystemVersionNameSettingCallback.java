 ...
 */
@Component("codeSystemVersionNameCallback")
public class CodeSystemVersionNameSettingCallback extends AbstractCodeSystemVersionNameSettingCallback<CodeSystemVersionCatalogEntry> {
	...
	public void afterBinding(
		...
		bindingResult.setCodeSystemVersionName(this.getCodeSystemVersionName(context.getCallbackIds()).toString());
	}
}
